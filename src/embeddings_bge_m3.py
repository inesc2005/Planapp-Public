...
============================
Classifica as 240 notícias do golden set usando o modelo BAAI/bge-m3 —
estado da arte em recuperação multilingue, 1024 dims, suporta até 8192 tokens.
Desenhado para comparação assimétrica (texto longo vs. descrição curta).

Output:
  data/evaluation/preds_embeddings_bge_m3.json
...
OUT_FILE     = OUT_DIR / "preds_embeddings_bge_m3.json"
OUT_DIR.mkdir(parents=True, exist_ok=True)

MODEL_NAME = "BAAI/bge-m3"

# =============================================================================
# DESCRIÇÕES EM LINGUAGEM NATURAL (bge-m3 funciona bem com frases naturais)
# =============================================================================
DESCRICOES = {
...
def classificar_bge_m3(df_gold: pd.DataFrame) -> dict:
...
def main():
    ...
    resultados = classificar_bge_m3(df_gold)
    ...
    print(f"\n  (paraphrase-mpnet: 90.8% | E5-large: 81.2%)")
