"""
Embeddings Semânticos com Descrições de Categorias (Zero-Shot)
==============================================================
Classifica as 240 notícias do golden set usando sentence-transformers
em vez de TF-IDF — captura significado semântico em vez de palavras exatas.

Modelo: paraphrase-multilingual-mpnet-base-v2 (suporta português)

Output:
  data/evaluation/preds_embeddings.json
...
OUT_FILE     = OUT_DIR / "preds_embeddings.json"
OUT_DIR.mkdir(parents=True, exist_ok=True)

MODEL_NAME = "paraphrase-multilingual-mpnet-base-v2"

# =============================================================================
# DESCRIÇÕES (palavras-chave — optimizadas para paraphrase-multilingual-mpnet)
# =============================================================================
DESCRICOES = {
...
def classificar_embeddings(df_gold: pd.DataFrame) -> dict:
...
def main():
    ...
    resultados = classificar_embeddings(df_gold)
